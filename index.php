...
<div class="relative container mx-auto mb-12 lg:mb-20 md:px-20 px-4">
  <div class="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-[#ffffff1a] rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] bg-gradient-to-r from-gray-950 to-gray-900">
    <div class="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
      <img class="w-full h-full object-cover md:object-right shadow-lg" width="800" alt="Login Form" height="730" src="https://silver-sunshine-319abc.netlify.app/assets/service-1-bvSONSha.png">
    </div>
    
    <div class="relative z-1 max-w-[17rem] ml-auto text-white">
      <h4 class="h4 mb-4">Login</h4>
      <form>
        <div class="body-2 mb-[3rem] text-n-3">Enter your credentials to access your account</div>
        <div class="flex flex-col mb-5">
          <label class="text-base text-n-1 mb-2" for="username">Username</label>
          <input class="bg-n-7 py-2 pl-10 text-base text-n-1 rounded-lg" id="username" type="text" placeholder="Username">
        </div>
        <div class="flex flex-col mb-5">
          <label class="text-base text-n-1 mb-2" for="email">Email</label>
          <input class="bg-n-7 py-2 pl-10 text-base text-n-1 rounded-lg" id="email" type="email" placeholder="Email">
        </div>
        <div class="flex flex-col mb-5">
          <label class="text-base text-n-1 mb-2" for="password">Password</label>
          <input class="bg-n-7 py-2 pl-10 text-base text-n-1 rounded-lg" id="password" type="password" placeholder="Password">
        </div>
        <div class="flex flex-col mb-5">
          <label class="text-base text-n-1 mb-2" for="full-name">Full Name</label>
          <input class="bg-n-7 py-2 pl-10 text-base text-n-1 rounded-lg" id="full-name" type="text" placeholder="Full Name">
        </div>
        <button class="mt-6 px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-full transition-all">Login</button>
      </form>
      <div class="text-center mt-5">
        <a class="text-base text-n-1" href="#">Forgot Password?</a>
      </div>
      <div class="text-center mt-5">
        <a class="text-base text-n-1" href="#">Don't have an account? Sign up</a>
      </div>
    </div>
  </div>
